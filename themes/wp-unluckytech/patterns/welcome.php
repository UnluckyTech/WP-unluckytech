...
<div class="wp-block-cover alignfull custom-cover-height">
    ...
    <img class="wp-block-cover__image-background wp-image-3838" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/home/bg1.webp' ) ); ?>" data-object-fit="cover" loading="lazy"/>
        ...
        <div class="content-inner container-fluid">
            <div class="row welcome-container">
                <div class="col-12 col-md-6 video-wrapper" style="position: relative;">
                    <!-- Placeholder Image -->
                    <img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/placeholder.webp' ) ); ?>" alt="Video Placeholder" style="width: 100%; height: auto;" loading="lazy">
                </div>
