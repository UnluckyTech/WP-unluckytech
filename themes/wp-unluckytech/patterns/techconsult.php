...
<div class="main-container">
    ...
    <!-- Services Banner -->
    <div class="main-banner" style="background-image: url('/wp-content/themes/wp-unluckytech/assets/images/services/consult.webp');">
        <div class="main-banner-overlay">
            <h1 class="main-title">Technical Consultation</h1>
        </div>
    </div> 
