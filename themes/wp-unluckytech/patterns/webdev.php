...
<div class="main-container">
    ...
    <!-- Services Banner -->
    <div class="main-banner" style="background-image: url('/wp-content/themes/wp-unluckytech/assets/images/services/webdev.webp');">
        <div class="main-banner-overlay">
            <h1 class="main-title">Web Development</h1>
        </div>
    </div> 
