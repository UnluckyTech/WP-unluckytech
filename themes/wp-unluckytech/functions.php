...
function wp_unluckytech_scripts() {
    ...
    $styles = array(
        ...
        'wp-unluckytech-service-services' => get_template_directory_uri() . '/assets/css/services/services.css',
        'wp-unluckytech-service-webdev' => get_template_directory_uri() . '/assets/css/services/webdev.css',
        'wp-unluckytech-service-sysconfig' => get_template_directory_uri() . '/assets/css/services/sysconfig.css',
        'wp-unluckytech-service-servmanage' => get_template_directory_uri() . '/assets/css/services/servmanage.css',
        'wp-unluckytech-service-techconsult' => get_template_directory_uri() . '/assets/css/services/techconsult.css',
        'wp-unluckytech-service-pc' => get_template_directory_uri() . '/assets/css/services/pc.css',
        'wp-unluckytech-service-itsupport' => get_template_directory_uri() . '/assets/css/services/itsupport.css',
